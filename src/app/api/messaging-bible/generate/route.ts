...
Return ONLY the JSON array, no markdown.`
          ...
          const messagingPillars = pillarsMatch ? pillarsMatch[0].substring(0, 2000) : '';
          ...
          await sql`
            UPDATE messaging_bibles SET
              ...
              messaging_pillars = ${messagingPillars || bible.messaging_pillars || '[]'},
              status = 'complete',
              updated_at = NOW()
            WHERE id = ${bibleId}
          `;
...
*This Narrative was generated by Monitus. A more detailed version will be available shortly — our AI team is processing your inputs.*
`;
}
