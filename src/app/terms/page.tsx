        ...
        <div className="space-y-10 text-[var(--text-secondary)] leading-relaxed">
          ...
          <section>
            ...
            <p>
              ...
              multiple formats. The Service is provided on a
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-3">7. Content Responsibility</h2>
            <p>
              You are solely responsible for ensuring that any content published through
