...
const PLANS = [
  {
    ...
    features: [
      'Full AI-led positioning interview',
      'Complete Narrative document (6 sections)',
      'Tailored messaging for CUO, CFO, CTO, CEO, Head of Distribution',
      'One worked example: live news article scored against your Narrative',
      'Branded PDF export of your Narrative',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      'Weekly monitoring across 50 scored articles per month',
      '3 LinkedIn drafts per week, in your voice',
      'Up to 20 content pieces per month',
      'One-click LinkedIn publishing via OAuth',
      'Engagement tracking: views, clicks, reactions per post',
  ...
  },
  {
    ...
    features: [
      ...
      'Daily monitoring across 200 scored articles per month',
      'Up to 100 content pieces per month',
      'All three content formats: LinkedIn posts, email commentary, trade media pitches',
      'Email export to Mailchimp and HubSpot',
      'Pre-written pitches to Insurance Times, Post Magazine, The Insurer',
      'Monthly intelligence report (PDF, board-ready)',
      'Weekly Priority View: top themes, angles, and competitor moves',
      'Up to 3 users',
    ],
    accent: 'var(--accent)',
    popular: true,
  ...
  },
  {
    ...
    features: [
      ...
      'Competitor tracking: share of voice, positioning gaps, weekly alerts',
      'Quarterly positioning review with Narrative refresh',
      'Briefing builder for investor meetings, board packs, and client calls',
      'Quarterly refresh of stakeholder messaging based on what landed',
      'Unlimited users',
    ],
    accent: 'var(--success)',
    popular: false,
